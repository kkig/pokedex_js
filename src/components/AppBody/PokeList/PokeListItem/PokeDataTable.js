    ...
    return (
        <div className="pokemon-info-table">
            ...
            <div className="data-row">
                ...
                <div className="data-text">
                    { props.item.detail.types.length > 0 ?
            ...
            <div className="data-row">
                ...
                <div className="data-text">
                    {   
                        props.item.detail.stats.length > 0 ?
            ...
            <div className="data-row">
                ...
                <div className="data-text">
                    { props.item.detail.evolChain.evolutions.length > 0 ? 
            ...
            <div className="data-row">
                ...
                <div className="data-text">
                    {   props.item.detail.abilities.length > 0 ?
            ...
            <div className="data-row">
                ...
                <div className="data-text">
                    {   
                        props.item.detail.moves.length > 0 ?
